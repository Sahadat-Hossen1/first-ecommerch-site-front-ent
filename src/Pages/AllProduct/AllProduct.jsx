    ...
    <div className="flex mx-auto">
      ...
      <div className=" grid grid-cols-1  md:grid-cols-3  mx-auto gap-2  py-2 ">
        ...
        {After_Filter_Data.map((product, i) => (
          <div
            className="card bg-base-100 sm:w-40 md:w-64 lg:w-72 xl:80 shadow-sm sm:px-2"
            key={i}
          >
            <figure>
              <img
            ...
            <div className="card-body">
              ...
              <p className="text-xsm ">{product.title}</p>
              ...
              <div className="card-actions justify-end">
                <button className="bg-amber-100 text-primary hover:bg-primary hover:text-amber-100 px-3 py-1 rounded-2xl transition-all delay-150">
                  Add to Card
                </button>
              </div>
            </div>
